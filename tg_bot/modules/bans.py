...
def ban(bot: Bot, update: Update, args: List[str]) -> str:
    ...
    try:
        ...
        keyboard = []
        reply = "{}  !".format(mention_html(member.user.id, member.user.first_name))
        ...
        if excp.message == "Replied message not found":
            ...
            # Do not reply
            reply = "{} The Ban has been given away !".format(mention_html(member.user.id, member.user.first_name))
...
*Admin only:*
 ...
 For Any help contact @ShadowsArena
"""
